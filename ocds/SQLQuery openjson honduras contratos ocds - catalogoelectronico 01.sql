...
drop table ENDPOINT_STG_2_OCDS_CatalogoElectronico
go

drop procedure SP_JSON_OCDS_CATALOGELEC_1
go




create procedure SP_JSON_OCDS_CATALOGELEC_1 as 
---------------------------------------
...
SET @json = (
	...
	where post = 'CatalogoElectronico'
...
BEGIN
	...
	'http://200.13.162.79/datosabiertos/CE/CE_datos_2020.json' as urljson,
	'CatalogoElectronico' as datasource,
	...
	*/
	...
	INTO ENDPOINT_STG_2_OCDS_CatalogoElectronico 
	FROM OPENJSON ( @json ) 
	WITH 
		(
...
EXEC SP_JSON_OCDS_CATALOGELEC_1
go


select top 10 * from ENDPOINT_STG_2_OCDS_CatalogoElectronico 
