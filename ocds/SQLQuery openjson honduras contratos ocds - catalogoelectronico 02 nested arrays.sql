...
truncate table ENDPOINT_STG_3_OCDS_CatalogoElectronico_contracts_documents
go
truncate table ENDPOINT_STG_3_OCDS_CatalogoElectronico_contracts
go
truncate table ENDPOINT_STG_3_OCDS_CatalogoElectronico_parties
go
truncate table ENDPOINT_STG_3_OCDS_CatalogoElectronico_tender
go
...
DECLARE release_ocid CURSOR FOR 
	...
	SELECT release_ocid,tender_id FROM ENDPOINT_STG_2_OCDS_CatalogoElectronico
...
WHILE @@FETCH_STATUS = 0
    BEGIN
		...
		SET @json = 
		(
			select top 1 tender from ENDPOINT_STG_2_OCDS_CatalogoElectronico where release_ocid = @ocid and tender_id = @tender_id 
		)

		INSERT into ENDPOINT_STG_3_OCDS_CatalogoElectronico_tender
		select 
		...
		*/
		...
		/*
		-- tender.documents
		--INSERT into ENDPOINT_STG_3_OCDS_CatalogoElectronico_tender_documents
		select 
		@ocid as ocid,@tender_id as tenderid,
		*
		FROM OPENJSON ( @json ) 
		...
		*/
		...
		SET @json = 
		(
			select top 1 parties from ENDPOINT_STG_2_OCDS_CatalogoElectronico where release_ocid = @ocid and tender_id = @tender_id 
		)
		
		INSERT into ENDPOINT_STG_3_OCDS_CatalogoElectronico_parties
		select 
		@ocid as ocid,@tender_id as tenderid,
		*
		...
		SET @json = 
		(
			select top 1 planning from ENDPOINT_STG_2_OCDS_CatalogoElectronico where release_ocid = @ocid and tender_id = @tender_id 
		)		
		--INSERT into ENDPOINT_STG_3_OCDS_CatalogoElectronico_planning_budget
		select 
		@ocid as ocid,@tender_id as tenderid,
		*
		...
		*/
		...
		SET @json = 
		(
			select top 1 budgetBreakdown from ENDPOINT_STG_2_OCDS_CatalogoElectronico where release_ocid = @ocid and tender_id = @tender_id 
		)
		...
		@ocid as ocid,@tender_id as tenderid,
		*
		--into ENDPOINT_STG_3_OCDS_CatalogoElectronico_planning_budget_budgetbreakdown
		FROM OPENJSON ( @json ) 
		WITH (
		...
		*/
		...
		SET @json = 
		(
			select top 1 contracts from ENDPOINT_STG_2_OCDS_CatalogoElectronico where release_ocid = @ocid and tender_id = @tender_id 
		)


		INSERT into ENDPOINT_STG_3_OCDS_CatalogoElectronico_contracts
		select 
		@ocid as ocid,@tender_id as tenderid,
		*
		...
		insert into ENDPOINT_STG_3_OCDS_CatalogoElectronico_contracts_documents
		select 
		@ocid as ocid,@tender_id as tenderid,
		*
...
select top 10 * from ENDPOINT_STG_3_OCDS_CatalogoElectronico_tender
go

select top 10 * from ENDPOINT_STG_3_OCDS_CatalogoElectronico_parties
go

select top 10 * from ENDPOINT_STG_3_OCDS_CatalogoElectronico_contracts
go

select top 10 * from ENDPOINT_STG_3_OCDS_CatalogoElectronico_contracts_documents
go
